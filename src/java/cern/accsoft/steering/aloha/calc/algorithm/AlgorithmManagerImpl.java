...
public class AlgorithmManagerImpl implements AlgorithmManager {
	...
	private final static Logger logger = Logger
			.getLogger(AlgorithmManagerImpl.class);

	/** all the factories */
	private List<AlgorithmFactory> factories = new ArrayList<AlgorithmFactory>();

	/** all the already instantiated algorithms */
	private Map<Solver, Algorithm> algorithms = new HashMap<Solver, Algorithm>();

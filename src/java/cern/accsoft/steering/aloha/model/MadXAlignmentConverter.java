...
public class MadXAlignmentConverter {
	...
	private final static Logger logger = Logger
			.getLogger(MadXAlignmentConverter.class);
	 ...
	 * 
	 * @param alignmentData
	 *            the data from which to create the misalignments
	 ...
	 * 
	 * @param misalignment
	 *            the misalignment to fill
	 * @param startValue
	 *            the alignment-value near the start of the element
	 * @param endValue
	 *            the alignment-value near the end of the element
	...
	private void fillMisalignment(Misalignment misalignment,
		...
		if (diffS < MIN_DIFF_S) {
			logger
					.warn("The minimum distance between two alignment-points of one element must be "

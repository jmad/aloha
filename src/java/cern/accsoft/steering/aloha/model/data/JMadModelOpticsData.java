 ...
 * 
 */
public class JMadModelOpticsData extends AbstractDynamicData implements
		ModelOpticsData {

	/** the logger for the class */
	private final static Logger logger = Logger
			.getLogger(JMadModelOpticsData.class);

	/** the model-delegate */
	private ModelDelegate modelDelegate;

	/** the buffered dispersion values for the monitors */
	private Map<String, List<Double>> monitorValuesMap = new HashMap<String, List<Double>>();
	 ...
	 * 
	 * @param prefix
	 *            the kind of data, where to set the value
	 * @param plane
	 *            the plane for which to set the value
	 * @param value
	 *            the value to set
	 */
	 ...
	 * 
	 * @param prefix
	 *            the kind of list to put
	 * @param plane
	 *            the plane for which to put the list
	 * @param valueList
	 *            the list to put
	 */
	 ...
	 * @param plane
	 *            the plane for which to get the date
	 ...
	 * 
	 * @param elementName
	 *            the name of the element for which to retrieve the opticsPoint
	...
	private JMadModel getModel() {
		...
		if (delegate instanceof JMadModelDelegate) {
			return ((JMadModelDelegate) delegate).getJMadModel();
		}
		return null;
	}
	...
	public List<Double> getMonitorSPositions(Plane plane) {
		List<Monitor> monitors = getMachineElementsManager().getActiveMonitors(
				plane);
		List<Double> sPositions = new ArrayList<Double>();
		for (Monitor monitor : monitors) {

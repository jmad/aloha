 ...
 * 
 */
public class CombinedDispersionDataImpl implements CombinedDispersionData,
		NoiseWeighterAware {

	/** the logger for the class */
	private final static Logger logger = Logger
			.getLogger(CombinedDispersionDataImpl.class);
	...
	/**
	 * @param dirty
	 *            the value, which to set the dirty-flag
	 */
	...
	private void calc() {
		...
		logger
				.info("norm of relative dispersion-vector / sqrt(#elements - 1) = "
						+ fitQuality);
	}
	 ...
	 * 
	 * @param plane
	 *            the plane for which to calculate the data
	 * @return the data
	 */

...
public abstract class ChartFactoryImpl implements ChartFactory {
	 ...
	 */
	public final Aloha2DChart createBarChart(DataSet measuredDataSet,
	...
	public final Aloha2DChart createBarChart(DataSet measuredDataSet,
		...
		if (measuredDataSet instanceof DataSetError) {
			 ...
			 * empty dataset.
			 */
			chart.setRenderer(ChartRendererRole.MEAS_ERROR,
					createErrorRenderer());
			chart.setRendererDataSet(ChartRendererRole.MEAS_ERROR,
					measuredDataSet);
		}
		if (modelDataSet != null) {
			chart

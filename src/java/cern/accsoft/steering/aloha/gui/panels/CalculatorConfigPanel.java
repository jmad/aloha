...
public class CalculatorConfigPanel extends JPanel implements Applyable {
	private static final long serialVersionUID = 4675880907133415663L;
	...
	private void initComponents() {
		...
		txtNoiseLimit
				.setToolTipText("A Noise-Value [m] below this limit is considered as zero noise.");
		...
		cboSolvers = new JComboBox(getSolverManager().getSolvers().toArray());
		cboSolvers.addActionListener(new ActionListener() {
	 ...
	 *            the sensityMatrixManagerConfig to set
	 */
	...
	/**
	 * @param noiseWeighterConfig
	 *            the noiseWeighterConfig to set
	 */
